...
RESOURCES += src/qt/jokecoin.qrc src/qt/jokecoin_locale.qrc

TRANSLATIONS += src/qt/locale/jokecoin_bg.ts \
                src/qt/locale/jokecoin_de.ts \
                src/qt/locale/jokecoin_en.ts \
                src/qt/locale/jokecoin_es.ts \
                src/qt/locale/jokecoin_fi.ts \
                src/qt/locale/jokecoin_fr.ts \
                src/qt/locale/jokecoin_it.ts \
                src/qt/locale/jokecoin_ja.ts \
                src/qt/locale/jokecoin_pl.ts \
                src/qt/locale/jokecoin_pt.ts \
                src/qt/locale/jokecoin_ru.ts \
                src/qt/locale/jokecoin_sk.ts \
                src/qt/locale/jokecoin_sv.ts \
                src/qt/locale/jokecoin_vi.ts \
                src/qt/locale/jokecoin_zh_CN.ts \
                src/qt/locale/jokecoin_zh_TW.ts

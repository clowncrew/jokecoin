...
def main():
    ...
    # Filter out hosts with multiple jokecoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple jokecoin ports' % (ip_stats(ips)), file=sys.stderr)

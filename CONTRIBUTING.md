Contributing to JokeCoin Core
============================

The JokeCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/jokecoin-project/jokecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the JokeCoin Core project, and is not to be
confused with overall JokeCoin Network Protocol consensus changes.

Whether a pull request is merged into JokeCoin Core rests with the project merge
...
Patches that change JokeCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the JokeCoin consensus, it must have been
...
The project leader is the release manager for each JokeCoin Core release.

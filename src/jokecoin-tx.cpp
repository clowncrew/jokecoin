...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("JokeCoin Core jokecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jokecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jokecoin transaction") + "\n" +
                               "  jokecoin-tx [options] -create [commands]   " + _("Create hex-encoded jokecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jokecoin transaction

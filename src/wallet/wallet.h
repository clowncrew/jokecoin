...
#ifndef JokeCoin_WALLET_H
#define JokeCoin_WALLET_H
...
public:
     ...
     * JokeCoin: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination

...
enum WalletFeature {
    ...
    FEATURE_PRE_JokeCoin = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZJOKE_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 10000 JOKE output and keys which can be used for the Masternode

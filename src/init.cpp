...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all JokeCoin specific functionality (Masternodes, Budgeting) (0-1, default: %u)"), 0));
...
bool AppInitMain()
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", JokeCoin_CONF_FILENAME)).string());

...
public:
    ...
    /**
     * Amount of jokecoin coming in to a transaction
...
// JokeCoin: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect

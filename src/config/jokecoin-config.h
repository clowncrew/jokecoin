/* src/config/jokecoin-config.h.  Generated from jokecoin-config.h.in by configure.  */
/* src/config/jokecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef JOKE_CONFIG_H

#define JOKE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/jokecoin-project/jokecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "JokeCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "JokeCoin Core 5.1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "jokecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://jokecoin.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "5.1.99"

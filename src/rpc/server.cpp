...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop JokeCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "JokeCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* JokeCoin features */
        {"jokecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"jokecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"jokecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"jokecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"jokecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"jokecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"jokecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"jokecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"jokecoin", "startmasternode", &startmasternode, true, true, false},
        {"jokecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"jokecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"jokecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"jokecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"jokecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"jokecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"jokecoin", "preparebudget", &preparebudget, true, true, false},
        {"jokecoin", "submitbudget", &submitbudget, true, true, false},
        {"jokecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"jokecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"jokecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"jokecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"jokecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"jokecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"jokecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"jokecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"jokecoin", "mnsync", &mnsync, true, true, false},
        {"jokecoin", "spork", &spork, true, true, false},
        {"jokecoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzjokeseed", &getzjokeseed, false, false, true},
        {"zerocoin", "setzjokeseed", &setzjokeseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzjoke", &searchdzjoke, false, false, true},
        {"zerocoin", "dzjokestate", &dzjokestate, false, false, true},
...
{
    return "> jokecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30503/\n";
}

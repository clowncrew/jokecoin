...
public:
    CMainParams()
    {
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "jokecoin.seed.fuzzbawls.pw", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("fuzzbawls.pw", "jokecoin.seed2.fuzzbawls.pw", true);    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "jokecoin-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("fuzzbawls.pw", "jokecoin-testnet.seed2.fuzzbawls.pw", true);

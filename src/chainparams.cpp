...
static Checkpoints::MapCheckpoints mapCheckpoints = {{ 0, uint256S("00000785a8752330bc13b72f9ede0039f0b4378834ba8894cf2bf7bd408c21eb")}};
static const Checkpoints::CCheckpointData data = { &mapCheckpoints, 1614602714, 0, 0};
    ...
    // * estimated number of transactions per day after checkpoint :m- value is wrong per comment, carried over from jokecoin v1, seems ok?
...
public: CMainParams() {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // JokeCoin starting difficulty is 1 / 2^12
        ...
        consensus.nTargetTimespan = 10 * 60; // modified per joke-5.1, prolly per jokev1, original value from pivx: 40*60
        consensus.nTargetTimespanV2 = 10 * 60; // same, original: 30*60
        consensus.nTargetSpacing = 10 * 60; // same, original: 1*60
        ...
        consensus.nTime_EnforceNewSporkKey = 1614602714;    //!> December 21, 2020 01:00:00 AM GMT :m- not really, timestamp from jcv1-wb
        consensus.nTime_RejectOldSporkKey = 1527811200;     //!> March 1, 2021 01:00:00 AM GMT
        // height-based activations
        consensus.height_last_invalid_UTXO = 999999999; // these values r just guesses, carried over from jokecoin-1
        consensus.height_last_ZC_AccumCheckpoint = 999999999; // i think? to suppress this check, should b no wrapper serials ne-way?
        consensus.height_last_ZC_WrappedSerials = 0;
        consensus.height_ZC_RecalcAccumulators = 999999999;
        // validation by-pass
        consensus.nJokeCoinBadBlockTime = 1621503368;    // Skip nBit validation of Block 10 001 per pivx PR #915; first pos block
        consensus.nJokeCoinBadBlockBits = 0x1c2469ac;    // same, watch out for block 10002 validate fail though!~
        ...
        consensus.ZC_TimeStart = 1614602714;        // October 17, 2017 4:30:00 AM :m- no it isn't, this is jokecoin genesis block timestamp
        consensus.vUpgrades[Consensus::BASE_NETWORK].nActivationHeight = Consensus::NetworkUpgrade::ALWAYS_ACTIVE;
        consensus.vUpgrades[Consensus::UPGRADE_TESTDUMMY].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight           = 10001;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight        = 999999999; // iv just ham-handed turned everything off
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight            = 999999999; // idk 100% what all these do
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight         = 999999999; // but they seems osrt of important, some of them
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 1808634; // didn't modify this - i think it does s/t 'normal;?
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 0;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 999999999; // if s/t isn't working
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 999999999; // these values are a possible culprit
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 999999999; // who knows what they should be?
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 999999999; // controlled by consensus/params.h
        ...
        /* kind of want to zero about above value, didn't bc was in previous jokecoin version merge-upstram-5.1.0, just mimicking that */
         ...
         */
        pchMessageStart[0] = 0xd0; //these values are from wb
        pchMessageStart[1] = 0xb1;
        pchMessageStart[2] = 0x9d;
        pchMessageStart[3] = 0x6a;
        nDefaultPort = 30504;
        // Note that of those with the service bits flag, most only support a subset of possible options
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 43); // :m- no clue what these do, coped values from wb
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "js"; // just changed p->j from pivx on these
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "jviews";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "jokeks";
        bech32HRPs[SAPLING_EXTENDED_SPEND_KEY]   = "j-secret-spending-key-main";
        bech32HRPs[SAPLING_EXTENDED_FVK]         = "jxviews";}
...
public: CTestNetParams() {
        ...
        consensus.ZC_MinMintFee = 1 * CENT;
        consensus.ZC_MinStakeDepth = 200;
        consensus.ZC_TimeStart = 1614602714;        // October 17, 2017 4:30:00 AM :m- jc genesis block timestamp
        // Network upgrades
        consensus.vUpgrades[Consensus::BASE_NETWORK].nActivationHeight = Consensus::NetworkUpgrade::ALWAYS_ACTIVE;
        consensus.vUpgrades[Consensus::UPGRADE_TESTDUMMY].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 262525; //looks weird but i didn't modify this
        /**
         * The message start string is designed to be unlikely to occur in normal data.
         * The characters are rarely used upper ASCII, not valid as UTF-8, and produce
         * a large 4-byte int at any alignment.
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet jokecoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);  // Testnet jokecoin script addresses start with '8' or '9'
        ...
        // Testnet jokecoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet jokecoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet jokecoin BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE] = {0x80, 0x00, 0x00, 0x01};
        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_test, pnSeed6_test + ARRAYLEN(pnSeed6_test));
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "jtestsapling";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "jviewtestsapling";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "jokektestsapling";
        bech32HRPs[SAPLING_EXTENDED_SPEND_KEY]   = "j-secret-spending-key-test";
        bech32HRPs[SAPLING_EXTENDED_FVK]         = "jxviewtestsapling";}
...
public: CRegTestParams() {
        ...
        */
        ...
        consensus.strSporkPubKeyOld = ""; // left this blank bc that's what pivx had this version, prev would been: 
        /* 04f64424cb7a30a32f524a0010fe9291391cb17076fdb96422b9f5c30b65dd8acc52cf7f13370abeee899cbada3ddb47883876e28e941f2dd94f1b1c5fad104666 */
        ...
        pchMessageStart[2] = 0x88;
        pchMessageStart[3] = 0xfd;
        nDefaultPort = 51476; // pivx, didn't change bc wb never changed this, would b as above i figure
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet jokecoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet jokecoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'

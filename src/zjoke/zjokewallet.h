...
#ifndef JokeCoin_ZJOKEWALLET_H
#define JokeCoin_ZJOKEWALLET_H
...
public:
    CzJOKEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZJOKE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZJOKE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

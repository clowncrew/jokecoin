...
#ifndef JokeCoin_LEGACY_ZPOS_H
#define JokeCoin_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZJokeStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZJokeStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZJOKE() const override { return true; }

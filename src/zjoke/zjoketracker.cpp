...
CzJOKETracker::CzJOKETracker(CWallet* parent)
{
    this->wallet = parent;
...
{
    bool iszJOKEWalletInitialized = (nullptr != zJOKEWallet);
    CMintMeta meta;
    ...
    if (!iszJOKEWalletInitialized)
        zJOKEWallet = new CzJOKEWallet(wallet);
...
std::set<CMintMeta> CzJOKETracker::ListMints(bool fUnusedOnly, bool fMatureOnly, bool fUpdateStatus, bool fWrongSeed, bool fExcludeV1)
{
    ...
    if (fUpdateStatus) {
        ...
        LogPrint(BCLog::LEGACYZC, "%s: added %d dzjoke from DB\n", __func__, listDeterministicDB.size());
    }

...
#include "qt/jokecoin/settings/settingsnetworkwidget.h"
#include "qt/jokecoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/jokecoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(JokeCoinGUI* _window, QWidget *parent) :

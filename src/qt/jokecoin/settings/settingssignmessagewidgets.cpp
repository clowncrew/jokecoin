...
#include "qt/jokecoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(JokeCoinGUI* _window, QWidget *parent) :

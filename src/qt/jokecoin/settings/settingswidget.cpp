...
#include "qt/jokecoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(JokeCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &JokeCoinGUI::openFAQ);

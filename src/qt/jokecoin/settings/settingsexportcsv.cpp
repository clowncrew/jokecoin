...
#include "qt/jokecoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(JokeCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("JokeCoin_tx_csv_export(*.csv)") : tr("JokeCoin_addresses_csv_export(*.csv)"),
                                        nullptr);

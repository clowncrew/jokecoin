...
#include "qt/jokecoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/jokecoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(JokeCoinGUI* _window, QWidget *parent) :

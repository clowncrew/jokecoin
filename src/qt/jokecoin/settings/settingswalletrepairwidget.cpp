...
#include "qt/jokecoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/jokecoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(JokeCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to JokeCoinGUI::handleRestart()

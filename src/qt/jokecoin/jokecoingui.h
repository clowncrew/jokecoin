...
#ifndef JokeCoin_CORE_NEW_GUI_JokeCoinGUI_H
#define JokeCoin_CORE_NEW_GUI_JokeCoinGUI_H
...
#include "qt/jokecoin/navmenuwidget.h"
#include "qt/jokecoin/topbar.h"
#include "qt/jokecoin/dashboardwidget.h"
#include "qt/jokecoin/send.h"
#include "qt/jokecoin/receivewidget.h"
#include "qt/jokecoin/addresseswidget.h"
#include "qt/jokecoin/coldstakingwidget.h"
#include "qt/jokecoin/masternodeswidget.h"
#include "qt/jokecoin/snackbar.h"
#include "qt/jokecoin/settings/settingswidget.h"
...
/**
  JokeCoin GUI main class. This class represents the main window of the JokeCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class JokeCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit JokeCoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~JokeCoinGUI();
...
#endif //JokeCoin_CORE_NEW_GUI_JokeCoinGUI_H

...
#include "qt/jokecoin/furabstractlistitemdelegate.h"
#include "qt/jokecoin/txviewholder.h"
#include "qt/jokecoin/tooltipmenu.h"
#include "qt/jokecoin/sendmultirow.h"
#include "qt/jokecoin/coldstakingmodel.h"
#include "qt/jokecoin/contactsdropdown.h"
#include "qt/jokecoin/addressholder.h"
...
public:
    explicit ColdStakingWidget(JokeCoinGUI* parent);
    ~ColdStakingWidget();

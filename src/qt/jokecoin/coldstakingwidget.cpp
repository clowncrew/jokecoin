...
#include "qt/jokecoin/forms/ui_coldstakingwidget.h"
#include "qt/jokecoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/jokecoin/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(JokeCoinGUI* parent) :
    PWidget(parent),

...
#include "qt/jokecoin/sendcustomfeedialog.h"
#include "qt/jokecoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(JokeCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &JokeCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

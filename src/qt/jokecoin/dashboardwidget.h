...
#include "config/jokecoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalJoke = 0;
    qint64 totalZjoke = 0;
    QList<qreal> valuesJoke;
    QList<qreal> valueszJoke;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(JokeCoinGUI* _window);
    ~DashboardWidget();

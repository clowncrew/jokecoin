...
/* JokeCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "JokeCoin"
#define QAPP_ORG_DOMAIN "jokecoin.org"
#define QAPP_APP_NAME_DEFAULT "JokeCoin-Qt"
#define QAPP_APP_NAME_TESTNET "JokeCoin-Qt-testnet"

...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(JOKE);
    unitlist.append(mJOKE);
    unitlist.append(uJOKE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case JOKE:
        return QString("jokecoin");
    case mJOKE:
        return QString("mjokecoin");
    case uJOKE:
        return QString::fromUtf8("ujokecoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZJOKE)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZJOKE);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZJOKE)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZJOKE));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}

...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            JokeCoinGUI* window = static_cast<JokeCoinGUI*>(parentWidget());
...
{
    JokeCoinGUI* gui = static_cast<JokeCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<JokeCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +

...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a JokeCoin address (e.g. %1)").arg("J7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
void openConfigfile()
{
    ...
    /* Open jokecoin.conf with the associated application */

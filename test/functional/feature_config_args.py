...
class ConfArgsTest(JokeCoinTestFramework):
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "jokecoin.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.jokecoin)

#!/usr/bin/env python3
# Copyright (c) 2020 The JokeCoin Core developers
...
class SaplingMempoolTest(JokeCoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 JOKE note to Alice
        ...
        # miner sends another 10 JOKE note to Alice

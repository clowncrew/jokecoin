...
class ListReceivedTest (JokeCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 JOKE.
        ...
        # Send 1 JOKE to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 JOKE sending them all (fee is 0.1 JOKE)
        ...
        # Confirm transaction (2 JOKE from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 JOKE, send 0.6 JOKE + 0.05 JOKE fee

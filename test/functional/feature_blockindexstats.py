...
class BlockIndexStatsTest(JokeCoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 JOKE "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 JOKE + 9 notes of 5 JOKE + 1 note of 4 JOKE (using 1.0 fee)

...
class FullBlockTest(JokeCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure jokecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure jokecoind isn't accepting b28
        ...
        # JokeCoin: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the jokecoin code has custom code which does so);

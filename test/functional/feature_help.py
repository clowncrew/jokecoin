...
"""Verify that starting jokecoin with -h works as expected."""
import subprocess

from test_framework.test_framework import JokeCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(JokeCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jokecoin with -? for help text")
        ...
        self.log.info("Start jokecoin with -version for version information")

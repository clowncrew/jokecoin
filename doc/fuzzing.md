...
To build JokeCoin Core using AFL instrumentation (this assumes that the
...
with certain assembly code from JokeCoin Core's code. See [developer notes on sanitizers](https://github.com/JokeCoin-Project/JokeCoin/blob/master/doc/developer-notes.md#sanitizers)

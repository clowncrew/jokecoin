JokeCoin Core version v5.1.0 is now available from:  <https://github.com/jokecoin-project/jokecoin/releases>
...
- #2249 Make box of JokeCoin Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better jokecoin.conf Masternode data error notification (furszy)

...
The build script we'll be using is contained in the JokeCoin github repository ([contrib/gitian-build.py](https://github.com/jokecoin-project/jokecoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the JokeCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/JokeCoin-Project/JokeCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, jokecoin-detached-sigs, and jokecoin GitHub repos.

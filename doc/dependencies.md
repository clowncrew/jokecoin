...
These are the dependencies currently used by JokeCoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| XCB |  |  |  |  | [Yes](https://github.com/jokecoin-project/jokecoin/blob/master/depends/packages/qt.mk#L87) (Linux only) |
| xkbcommon |  |  |  |  | [Yes](https://github.com/jokecoin-project/jokecoin/blob/master/depends/packages/qt.mk#L86) (Linux only) |
